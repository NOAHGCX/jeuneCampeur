    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 py-2 bg-white border border-gray-200 rounded shadow-lg">
          <a href="/profil/mes-commandes" className="block px-4 py-2 hover:bg-gray-100">Mes commandes</a>
          <a href="/profil/mes-wishlists" className="block px-4 py-2 hover:bg-gray-100">Mes wishlists</a>
          <a href="/profil/mes-informations" className="block px-4 py-2 hover:bg-gray-100">Mes informations</a>
        </div>
      )}
    </div>
  );
